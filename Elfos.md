...
## 🔮 Rama Natural / Espiritual
[Aprendiz](Aprendiz.md) → [Hechicero](Hechicero.md) → [Brujo](Brujo.md) → [Chaman](Chaman.md) → [Druida](Druida.md)

---

## 🔥 Rama Demonológica Superior
[Aprendiz](Aprendiz.md) → [Demonologo](Demonologo.md) → [Pandemonio](Pandemonio.md) → [Modeus](Modeus.md) → [Adeus](Adeus.md)

---

## 💀 Rama Nigromántica
[Aprendiz](Aprendiz.md) → [Demonologo](Demonologo.md) → [Nigromante](Nigromante.md) → [Liche](Liche.md) → [Segador](Segador.md)
